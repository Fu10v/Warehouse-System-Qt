...
public:
    ...
    void setupUi(QDialog *ConnectionDialog)
    {
        ...
        gridLayout_2 = new QGridLayout(ConnectionDialog);
        gridLayout_2->setObjectName("gridLayout_2");
        portSpinBox = new QSpinBox(ConnectionDialog);
        portSpinBox->setObjectName("portSpinBox");
        portSpinBox->setMaximum(999999);

        gridLayout_2->addWidget(portSpinBox, 0, 1, 1, 1);

        hostLineEdit = new QLineEdit(ConnectionDialog);
        ...
        gridLayout_2->addWidget(hostLineEdit, 0, 0, 1, 1);

        dbNameLineEdit = new QLineEdit(ConnectionDialog);
        dbNameLineEdit->setObjectName("dbNameLineEdit");

        gridLayout_2->addWidget(dbNameLineEdit, 1, 0, 1, 2);

        passLineEdit = new QLineEdit(ConnectionDialog);
        passLineEdit->setObjectName("passLineEdit");

        gridLayout_2->addWidget(passLineEdit, 2, 0, 1, 2);

        connectPushButton = new QPushButton(ConnectionDialog);
        connectPushButton->setObjectName("connectPushButton");

        gridLayout_2->addWidget(connectPushButton, 3, 0, 1, 1);

        cancelPushButton = new QPushButton(ConnectionDialog);
        cancelPushButton->setObjectName("cancelPushButton");

        gridLayout_2->addWidget(cancelPushButton, 3, 1, 1, 1);
    ...
    {
        ConnectionDialog->setWindowTitle(QCoreApplication::translate("ConnectionDialog", "Connection Window", nullptr));
        connectPushButton->setText(QCoreApplication::translate("ConnectionDialog", "Connect", nullptr));
        cancelPushButton->setText(QCoreApplication::translate("ConnectionDialog", "Cancel", nullptr));
    } // retranslateUi
